...
local function open(prompt)
    ...
    prompt.Policy.BackgroundTransparency = 0.3 
    prompt.Policy.Shadow.Image.ImageTransparency = 0.6
    ...
    tweenService:Create(prompt.Policy, TweenInfo.new(0.4, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {BackgroundTransparency = 0.3}):Play() 
...
function promptRet.create(title, description, primary, secondary, callback)
    ...
    prompt.Policy.Actions.Primary.Interact.MouseEnter:Connect(function()
        ...
        tweenService:Create(prompt.Policy.Actions.Primary, TweenInfo.new(0.4, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {BackgroundTransparency = 0.2}):Play() -- 调整为半透明效果
    ...
    prompt.Policy.Actions.Primary.Interact.MouseLeave:Connect(function()
        if debounce then return end
        tweenService:Create(prompt.Policy.Actions.Primary, TweenInfo.new(0.4, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {BackgroundTransparency = 0.3}):Play()
